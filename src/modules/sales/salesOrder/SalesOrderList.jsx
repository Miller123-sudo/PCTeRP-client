...
export default function SalesOrderList() {
    ...
    const columns = [
        ...
        { headerName: 'Customer', field: 'customer', flex: 1, valueGetter: (params) => params.data?.customer ? params.data?.customer[0].name : "Not Available" },
        { headerName: 'Date', field: 'date', flex: 1, valueGetter: (params) => params.data?.date ? moment(params.data?.date).format("MM/DDYYYY") : "Not Available" },
        { headerName: 'Delivery Date', field: 'deliveryDate', flex: 1, valueGetter: (params) => params.data?.deliveryDate ? moment(params.data?.deliveryDate).format("MM/DDYYYY") : "Not Available" },
