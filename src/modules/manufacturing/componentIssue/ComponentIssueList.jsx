...
export default function ComponentIssueList({ data }) {
    ...
    const columns = [
        {
            headerName: '#', field: 'id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <>
                    ...
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/manufacturings/componentIssue/${params.value}?mode=view`}><BsEyeFill /></Button>
                </>
        },
