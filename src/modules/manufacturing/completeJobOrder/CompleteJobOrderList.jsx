...
export default function CompleteJobOrderList({ data }) {
    ...
    const columns = [
        {
            headerName: '#', field: 'id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <>
                    ...
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/manufacturings/completeJobOrder/${params.value}?mode=view`}><BsEyeFill /></Button>
                </>
        },
