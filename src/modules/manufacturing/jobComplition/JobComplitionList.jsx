...
export default function JobComplitionList({ data }) {
    ...
    const columns = [
        {
            headerName: '#', field: 'id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <>
                    {/* <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/manufacturings/jobComplition/${params.value}?mode=edit`}><BsBoxArrowInUpRight /></Button> */}
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/manufacturings/jobComplition/${params.value}?mode=view`}><BsEyeFill /></Button>
                </>
        },
        { headerName: 'Document NO.', field: 'name' },
        { headerName: 'SourceDocument', field: 'sourceDocument.name' },
        ...
        { headerName: 'Operation', field: 'operationName' },
        { headerName: 'Qty', field: 'quantity' },
        { headerName: 'Created Date', field: 'date', valueGetter: (params) => params.data?.date ? moment(params.data?.date).format("DD/MM/YYYY HH:mm:ss") : "Not Available" },
        { headerName: 'Start Date', field: 'startTime' },
        { headerName: 'End Date', field: 'endTime' },
        { headerName: 'JOb Duration(days:hr:min:sec)', field: 'duration' },
    ...
    useEffect(async () => {
        ...
        // const response = await ApiService.get('jobComplition');
            ...
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        ...
                        <Col><h6>Total: {data.length}</h6></Col>
                    </Row>
                    <Row>
